...
app.get("/",(req,res)=>{
  res.render("home", {firstPost:homeStartingContent, 
                      dailyJournal: diary, 
                    })
})
...
app.post("/compose",(req,res)=>{
  const dailyPost = {
    title: req.body.postTxt,
    body: req.body.blogArea
  }
  diary.push(dailyPost);
  res.redirect("/")
  
})

app.get("/posts/:day", (req, res)=>{
  let postName = lodash.lowerCase(req.params.day);
